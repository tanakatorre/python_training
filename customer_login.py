...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        driver = self.driver
        driver.get("https://helentest.helen-marlen.com/")
        driver.find_element_by_link_text("Login").click()
        driver.find_element_by_name("login[username]").click()
        driver.find_element_by_name("login[username]").clear()
        driver.find_element_by_name("login[username]").send_keys("ttt060418@gmail.com")
        driver.find_element_by_name("login[password]").clear()
        driver.find_element_by_name("login[password]").send_keys("111222qqq")
        driver.find_element_by_name("send").click()
        driver.find_element_by_link_text(u"Тестовый").click()
